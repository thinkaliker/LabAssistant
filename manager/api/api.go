...
func Router(d Deps) http.Handler {
	...
	mux.HandleFunc("GET /api/v1/updates", d.updates)
	...
	mux.HandleFunc("GET /api/v1/sudo", d.listSudoPrompts)
	mux.HandleFunc("POST /api/v1/sudo/{id}", d.submitSudo)
	mux.HandleFunc("POST /api/v1/sudo/{id}/cancel", d.cancelSudo)
